...
declare namespace JSX {
  interface IntrinsicElements {
    ...
    "s-badge": React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement> & {
      tone?: "success" | "critical" | "info" | "neutral" | "caution" | "warning" | "auto";
      children?: React.ReactNode;
    };
    ...
    "s-banner": React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement> & {
      tone?: "success" | "critical" | "info" | "neutral" | "caution" | "warning";
      children?: React.ReactNode;
    };
    "s-text-field": React.DetailedHTMLProps<React.InputHTMLAttributes<HTMLElement>, HTMLElement> & {
      name?: string;
      label?: string;
      defaultValue?: string;
      helpText?: string;
    };
    "s-select": React.DetailedHTMLProps<React.SelectHTMLAttributes<HTMLElement>, HTMLElement> & {
      name?: string;
      label?: string;
      defaultValue?: string;
    };
