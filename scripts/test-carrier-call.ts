...
const recipientPhone = process.env.TEST_CARRIER_PHONE;
if (!recipientPhone?.startsWith("+")) {
  throw new Error("Set TEST_CARRIER_PHONE to an authorized E.164 test number.");
}
...
console.log(
  "Placing carrier trace call to authorized number ending",
...
console.log(
  "Confidence:",
  call.completionConfidenceScore,
  "(",
  call.completionConfidenceLabel,
  ")",
);
